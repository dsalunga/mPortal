# P046 - WCMS.Framework.Core.XmlProvider

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebSystem/WCMS.Framework.Core.XmlProvider/WCMS.Framework.Core.XmlProvider.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.Framework.Core.XmlProvider` |
