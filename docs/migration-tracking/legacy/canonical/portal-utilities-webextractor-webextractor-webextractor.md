...
| Field | Value |
|---|---|
| Project Path | `legacy/Portal/Utilities/WebExtractor/WebExtractor/WebExtractor.csproj` |
| Project Kind | Utility Project |
| Assembly Name | `WebExtractor` |
...
| --- | --- | --- | --- | --- | --- | --- |
| Application Entry Point | `(root)` | `Program` | Not Stated | TBD | `TBD` | `Program.cs` |
