# P032 - WCMS.WebSystem.Apps.Forum

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebParts/SystemPartsG2/WCMS.WebSystem.WebParts.Forum/WCMS.WebSystem.Apps.Forum.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.WebSystem.WebParts.Forum` |
...
| --- | --- | --- | --- | --- | --- | --- |
| Core Component | `(root)` | `Forum` | Not Stated | TBD | `TBD` | `Forum.cs` |
| Core Component | `(root)` | `ForumCategory` | Not Stated | TBD | `TBD` | `ForumCategory.cs` |
| Core Component | `(root)` | `ForumPost` | Not Stated | TBD | `TBD` | `ForumPost.cs` |
| Core Component | `(root)` | `ForumThread` | Not Stated | TBD | `TBD` | `ForumThread.cs` |
