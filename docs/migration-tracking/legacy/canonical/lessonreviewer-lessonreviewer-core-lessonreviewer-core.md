# P004 - LessonReviewer.Core

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/LessonReviewer/LessonReviewer.Core/LessonReviewer.Core.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.LessonReviewer.Core` |
...
| --- | --- | --- | --- | --- | --- | --- |
| Manager Component | `(root)` | `ConfigManager` | Not Stated | TBD | `TBD` | `ConfigManager.cs` |
| Core Component | `(root)` | `MakeUpServiceSession` | Not Stated | TBD | `TBD` | `MakeUpServiceSession.cs` |
| Helper Component | `(root)` | `PlaybackHelper` | Not Stated | TBD | `TBD` | `PlaybackHelper.cs` |
| Assembly Metadata | `Properties` | `AssemblyInfo` | Not Stated | TBD | `TBD` | `Properties/AssemblyInfo.cs` |
| Core Component | `(root)` | `ServiceDefinition` | Not Stated | TBD | `TBD` | `ServiceDefinition.cs` |
