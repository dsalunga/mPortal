# P033 - WCMS.WebSystem.Apps.Social.ViewModel

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebParts/SystemPartsG2/WCMS.WebSystem.WebParts.Social.ViewModel/WCMS.WebSystem.Apps.Social.ViewModel.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.WebSystem.WebParts.Social.ViewModel` |
...
| --- | --- | --- | --- | --- | --- | --- |
| Helper Component | `(root)` | `EventViewModelHelper` | Not Stated | TBD | `TBD` | `EventViewModelHelper.cs` |
| Assembly Metadata | `Properties` | `AssemblyInfo` | Not Stated | TBD | `TBD` | `Properties/AssemblyInfo.cs` |
| Core Component | `(root)` | `WallEventViewModel` | Not Stated | TBD | `TBD` | `WallEventViewModel.cs` |
