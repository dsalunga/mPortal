...
| --- | --- | --- | --- | --- | --- |
| LGC-043 | Not Stated | Class Component | legacy/Portal/Utilities/DbManager/DbManager :: Program | Library/business component; assess API compatibility and dependencies. | `legacy/Portal/Utilities/DbManager/DbManager/Program.cs` |
