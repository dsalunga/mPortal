...
| --- | --- | --- | --- | --- | --- |
| LGC-047 | Not Stated | Class Component | legacy/Portal/Utilities/WebExtractor/WebExtractor :: Program | Library/business component; assess API compatibility and dependencies. | `legacy/Portal/Utilities/WebExtractor/WebExtractor/Program.cs` |
