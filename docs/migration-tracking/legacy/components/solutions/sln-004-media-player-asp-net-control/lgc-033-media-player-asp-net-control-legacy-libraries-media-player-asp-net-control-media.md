...
| --- | --- | --- | --- | --- | --- |
| LGC-033 | Partial | Class Component | legacy/Libraries/Media-Player-ASP.NET-Control/Media-Player-ASP.NET-Control :: Media Player Control | Library/business component; assess API compatibility and dependencies. | `legacy/Libraries/Media-Player-ASP.NET-Control/Media-Player-ASP.NET-Control/Media_Player_Control.cs` |
