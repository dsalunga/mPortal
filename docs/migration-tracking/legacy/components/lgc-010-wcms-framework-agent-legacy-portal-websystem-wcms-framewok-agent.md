...
| --- | --- | --- | --- | --- | --- |
| LGC-010 | Not Stated | Class Component | legacy/Portal/WebSystem/WCMS.Framewok.Agent :: Program | Library/business component; assess API compatibility and dependencies. | `legacy/Portal/WebSystem/WCMS.Framewok.Agent/Program.cs` |
