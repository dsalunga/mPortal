...
| --- | --- | --- | --- | --- | --- |
| LGC-045 | Not Stated | Class Component | legacy/Portal/Utilities/MySQL TableEditor :: Form1 | `legacy/Portal/Utilities/MySQL TableEditor/Form1.cs` | Library/business component; assess API compatibility and dependencies. |
