...
| Project File | `legacy/Portal/Utilities/WebExtractor/WebExtractor/WebExtractor.csproj` |
| Project Directory | `legacy/Portal/Utilities/WebExtractor/WebExtractor` |
| Output Type | Exe |
...
| --- | --- | --- | --- | --- | --- |
| LGC-047 | Not Stated | Class Component | legacy/Portal/Utilities/WebExtractor/WebExtractor :: Program | `legacy/Portal/Utilities/WebExtractor/WebExtractor/Program.cs` | Library/business component; assess API compatibility and dependencies. |
