# P049 - WCMS.WebSystem.Utilities

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebSystem/WCMS.WebSystem.Utilities/WCMS.WebSystem.Utilities.csproj` |
| Project Kind | Utility Project |
| Assembly Name | `WCMS.WebSystem.Utilities` |
...
|---|---|---|---|---|---|---|
| Manager Component | `(root)` | `DbManager` | `DbManager.cs` | Not Stated | TBD | `TBD` |
| Task/Job Component | `EmailUpdater` | `EmailUpdaterTask` | `EmailUpdater/EmailUpdaterTask.cs` | Not Stated | TBD | `TBD` |
| Assembly Metadata | `Properties` | `AssemblyInfo` | `Properties/AssemblyInfo.cs` | Not Stated | TBD | `TBD` |
| Task/Job Component | `Spammer` | `SenderTask` | `Spammer/SenderTask.cs` | Not Stated | TBD | `TBD` |
