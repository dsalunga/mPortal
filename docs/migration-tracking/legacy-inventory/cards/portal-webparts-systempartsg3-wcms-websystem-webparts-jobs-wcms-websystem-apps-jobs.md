# P038 - WCMS.WebSystem.Apps.Jobs

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebParts/SystemPartsG3/WCMS.WebSystem.WebParts.Jobs/WCMS.WebSystem.Apps.Jobs.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.WebSystem.WebParts.Jobs` |
...
|---|---|---|---|---|---|---|
| Core Component | `(root)` | `Job` | `Job.cs` | Not Stated | TBD | `TBD` |
| Core Component | `(root)` | `JobResult` | `JobResult.cs` | Not Stated | TBD | `TBD` |
| Assembly Metadata | `Properties` | `AssemblyInfo` | `Properties/AssemblyInfo.cs` | Not Stated | TBD | `TBD` |
| Provider Component | `Providers` | `IJobProvider` | `Providers/IJobProvider.cs` | Not Stated | TBD | `TBD` |
| Provider Component | `Providers` | `JobSqlProvider` | `Providers/JobSqlProvider.cs` | Not Stated | TBD | `TBD` |
