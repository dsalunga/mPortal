...
| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebParts/BranchLocator/WCMS.WebSystem.Apps.BranchLocator/WCMS.WebSystem.Apps.BranchLocator.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.WebSystem.Apps.BranchLocator` |
