...
| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebSystem/WCMS.Framework.Core.SqlProvider.Smo/WCMS.Framework.Core.SqlProvider.Smo.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.Framework.Core.SqlProvider.Smo` |
...
| Core Component | `(root)` | `SqlScriptGenerator` | `SqlScriptGenerator.cs` | Not Stated | TBD | `TBD` |
