# P035 - WCMS.WebSystem.Apps

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebParts/SystemPartsG2/WCMS.WebSystem.WebParts/WCMS.WebSystem.Apps.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `WCMS.WebSystem.SystemPartsG2` |
