# P019 - WCMS.WebSystem.Apps.Integration.UnitTest

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Portal/WebParts/Integration/WCMS.WebSystem.Apps.Integration.UnitTest/WCMS.WebSystem.Apps.Integration.UnitTest.csproj` |
| Project Kind | Test/SDK Project |
| Assembly Name | `WCMS.WebSystem.Apps.Integration.UnitTest` |
...
| --- | --- | --- | --- | --- | --- | --- |
| Core Component | `(root)` | `MemberHelperTests` | Not Stated | TBD | `TBD` | `MemberHelperTests.cs` |
| Assembly Metadata | `Properties` | `AssemblyInfo` | Not Stated | TBD | `TBD` | `Properties/AssemblyInfo.cs` |
| Core Component | `(root)` | `UnitTest1` | Not Stated | TBD | `TBD` | `UnitTest1.cs` |
