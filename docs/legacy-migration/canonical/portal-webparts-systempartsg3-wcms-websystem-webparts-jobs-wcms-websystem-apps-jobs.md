...
| --- | --- | --- | --- | --- | --- | --- |
| Core Component | `(root)` | `Job` | Not Stated | TBD | `TBD` | `Job.cs` |
| Core Component | `(root)` | `JobResult` | Not Stated | TBD | `TBD` | `JobResult.cs` |
| Assembly Metadata | `Properties` | `AssemblyInfo` | Not Stated | TBD | `TBD` | `Properties/AssemblyInfo.cs` |
| Provider Component | `Providers` | `IJobProvider` | Not Stated | TBD | `TBD` | `Providers/IJobProvider.cs` |
| Provider Component | `Providers` | `JobSqlProvider` | Not Stated | TBD | `TBD` | `Providers/JobSqlProvider.cs` |
