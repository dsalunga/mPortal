# P006 - Media-Player-ASP.NET-Control

## Project Tracking Summary

| Field | Value |
|---|---|
| Project Path | `legacy/Libraries/Media-Player-ASP.NET-Control/Media-Player-ASP.NET-Control/Media-Player-ASP.NET-Control.csproj` |
| Project Kind | Library/Component |
| Assembly Name | `Media-Player-ASP.NET-Control` |
...
| --- | --- | --- | --- | --- | --- | --- |
| Core Component | `(root)` | `Media_Player_Control` | Not Stated | TBD | `TBD` | `Media_Player_Control.cs` |
