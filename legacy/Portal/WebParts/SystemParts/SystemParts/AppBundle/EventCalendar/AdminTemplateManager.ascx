<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminTemplateManager.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.EventCalendar.AdminTemplateManager" %>
<div class="control-box no-bottom-margin">
    <div>
        <asp:Button ID="cmdNew" runat="server" Text="New Template" CssClass="btn btn-default btn-sm" OnClick="cmdNew_Click" />
...
<div class="table-responsive">
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-borderless"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Name" HeaderText="Name" SortExpression="Name" HeaderStyle-HorizontalAlign="Left" HtmlEncode="false" />
            <asp:BoundField DataField="ForeColor" HeaderText="ForeColor" SortExpression="ForeColor" HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="BackColor" HeaderText="BackColor" SortExpression="BackColor" HeaderStyle-HorizontalAlign="Left" />
        </Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.WebParts.EventCalendar.AdminTemplateManager">
        <SelectParameters>
