<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CategoryManagerView.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Incident.CategoryManagerView" %>
<div class="control-box no-bottom-margin">
    <div>
        <asp:Button ID="cmdNew" runat="server" Text="New Category" CssClass="btn btn-default btn-sm" OnClick="cmdNew_Click" />
...
<div class="table-responsive">
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
        ...
        GridLines="None" Width="100%" OnRowCommand="GridView1_RowCommand" CssClass="table table-borderless table-condensed" AllowPaging="True"
        PageSize="15">
        ...
        <Columns>
            ...
            <asp:BoundField DataField="GroupName" HeaderText="Support Group" SortExpression="GroupName"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.WebParts.Incident.CategoryManagerView">
        <SelectParameters>
