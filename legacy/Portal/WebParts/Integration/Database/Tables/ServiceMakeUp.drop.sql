...
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF_Table1_AssignedCouncillorId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[LessonReviewerSession] DROP CONSTRAINT [DF_Table1_AssignedCouncillorId]
END
