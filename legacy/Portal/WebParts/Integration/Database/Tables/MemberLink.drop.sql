...
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__MemberLin__Local__560DCABE]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MemberLink] DROP CONSTRAINT [DF__MemberLin__Local__560DCABE]
END
