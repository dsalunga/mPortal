...
<div class="system-login">
    <asp:MultiView ID="MultiView1" runat="server">
        <asp:View ID="viewLogin" runat="server">
            ...
            <table border="0">
                <tr>
                    <td style="text-align: right">Group&nbsp;ID<asp:RequiredFieldValidator ID="UserNameRequired" runat="server" ControlToValidate="txtUserName"
                        ErrorMessage="Email or Group ID is required." ForeColor="Red" ToolTip="Email or Group ID is required."
                        ValidationGroup="Login1">*</asp:RequiredFieldValidator>&nbsp;
                    </td>
                    <td>
                        <asp:TextBox ID="txtUserName" CssClass="form-control" ClientIDMode="Static" runat="server" Text="" placeholder="Your Group ID or Email"></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 10px">
                        <asp:TextBox ID="txtPassword" CssClass="form-control" ClientIDMode="Static" runat="server" TextMode="Password" Text=""></asp:TextBox>
                    </td>
                </tr>
                ...
                <tr>
                    <td></td>
                    <td>
                        <asp:Button ID="cmdLogin" ClientIDMode="Static" Width="80px" CssClass="btn btn-primary" data-loading-text="Logging in..." runat="server" Text="Login"
                ...
                <tr runat="server" id="panelSignUpLink" clientidmode="static" visible="false">
                    ...
                    <td><br />
                        <hr style="height: 1px; margin-top: 5px; margin-bottom: 5px" />
                        <div>
                            No account or cannot login? <a id="linkSignup" runat="server" href="#" class="BlueLink"
                                title="Click here to Register">Get Access</a>
                        </div>
                    </td>
                </tr>
            </table>
