<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminInterpreterScoreManager.ascx.cs" Inherits="WCMS.WebSystem.Apps.MusicCompetition.AdminInterpreterScoreManager" %>
...
<asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-borderless"
    ...
    <Columns>
        ...
        <asp:BoundField DataField="Interpreter" HeaderText="Interpreter" SortExpression="Interpreter"
            HeaderStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="Judge" HeaderText="Judge" SortExpression="Judge"
            HeaderStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="VoiceQuality" HeaderText="Voice Quality" SortExpression="VoiceQuality"
            HeaderStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="Interpretation" HeaderText="Interpretation" SortExpression="Interpretation"
            HeaderStyle-HorizontalAlign="Left" />
        <asp:BoundField DataField="StagePresence" HeaderText="Stage Presence" SortExpression="StagePresence"
            HeaderStyle-HorizontalAlign="Left" />
...
<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
    TypeName="WCMS.WebSystem.Apps.MusicCompetition.AdminInterpreterScoreManager">
    <SelectParameters>
