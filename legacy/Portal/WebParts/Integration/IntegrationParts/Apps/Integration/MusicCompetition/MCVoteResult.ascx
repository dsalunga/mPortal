<%@ Control Language="C#" ClassName="WCMS.WebSystem.Apps.MusicCompetition.MCVoteResult"
...
<body>
    <div data-role="page" id="pageResult">
        ...
        <div data-role="content">
            <h1 runat="server" id="lblVotingEnded" visible="false" style="text-align: center; color: orange;">{{ VOTING HAS ENDED }}<br />
                <br />
            </h1>
