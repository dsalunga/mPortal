<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ConfigMembers.ascx.cs"
    Inherits="WCMS.WebSystem.Apps.Integration.ConfigMembers" %>
<div class="control-box">
    <div>
        <asp:Button ID="cmdSync" runat="server" Text="Sync" CssClass="btn btn-default"
...
<div>
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-borderless"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="FullName" HeaderText="Name" SortExpression="FullName"
                HeaderStyle-HorizontalAlign="Left" />
            <asp:BoundField DataField="Email" HeaderText="Email" SortExpression="Email" HeaderStyle-HorizontalAlign="Left"></asp:BoundField>
        </Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.Apps.Integration.ConfigMembers"></asp:ObjectDataSource>
</div>
