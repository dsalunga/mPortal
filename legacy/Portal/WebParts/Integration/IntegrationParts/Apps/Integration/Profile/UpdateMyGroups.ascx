...
<span id="panelLocaleGroups" runat="server" clientidmode="static">
    <br />
    <h3>Locale Group</h3>
    <asp:RadioButtonList DataTextField="Name" CssClass="aspnet-radio" DataValueField="Id" ID="rblLocaleGroups"
        runat="server">
    </asp:RadioButtonList>
</span>
<span id="panelMinistries" runat="server" clientidmode="static">
    <br />
...
<span id="panelSpecialGroups" runat="server" clientidmode="static">
    <br />
    <br />
    <h3>Special Groups</h3>
    <asp:CheckBoxList RepeatDirection="Vertical" CssClass="aspnet-checkbox" RepeatLayout="Flow" RepeatColumns="1"
