...
<div class="event-calendar">
    <div style="padding-bottom: 10px">
        <asp:Button ID="cmdPreviousYear" ToolTip="Previous Year" runat="server" Text="&lt;&lt;"
            OnClick="cmdPreviousYear_Click" Visible="false" CssClass="btn btn-default btn-sm" /><asp:Button ID="cmdPrevious" runat="server"
                ToolTip="Previous Month" OnClick="cmdPrevious_Click" Text="&lt;&lt;" CssClass="btn btn-default" />
        <asp:DropDownList ID="cboMonth" runat="server" AutoPostBack="True" CssClass="input" OnSelectedIndexChanged="cboMonth_SelectedIndexChanged">
        </asp:DropDownList>
        <asp:DropDownList ID="cboYear" runat="server" AutoPostBack="True" CssClass="input" OnSelectedIndexChanged="cboYear_SelectedIndexChanged">
        </asp:DropDownList>
        <asp:Button ID="cmdNext" runat="server" ToolTip="Next Month" CssClass="btn btn-default btn-sm" OnClick="cmdNext_Click"
            Text="&gt;&gt;" /><asp:Button ID="cmdNextYear" runat="server" Text="&gt;&gt;" OnClick="cmdNextYear_Click"
                ToolTip="Next Year" Visible="false" CssClass="btn btn-default btn-sm" />
        &nbsp;
            <asp:Button ID="cmdToday" runat="server" Text="Today" OnClick="cmdToday_Click" CssClass="btn btn-default btn-sm" />
    </div>
    <asp:Calendar ID="monthCalendar" runat="server" BorderWidth="1px"
        ...
        <TitleStyle Font-Bold="True" Font-Size="12pt" BackColor="#565656" CssClass="EventCalendar-Calendar-Title" />
    </asp:Calendar>
    <br />
    <br />
</div>
