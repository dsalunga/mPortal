...
<head>
    ...
    <!--<link rel='stylesheet' media='screen and (max-width: 800px)' href='css/narrow.css' />-->
...
<body>
    <form runat="server">
        ...
        <div id="contents" runat="server" class="header">
            <a href="index.html">
                <img class="logo" src="/Content/Themes/Integration/MusicCompetition/v2/images/logosmall.png" alt="Asop Logo" /></a>
            <ul>
                <li class="textshadow1 menu_list"><a href="show.html">The Show</a></li>
                <li class="textshadow1 menu_list"><a href="#">Gallery</a></li>
                <li class="textshadow1 menu_list"><a href="talk.html">Talk</a></li>
        ...
        <div id="content" class="content_section_holder gradient_section">
            <div class="content_wrap" id="breadcrumb" runat="server">
                <p class="breadcrumbs"><a href="index.html">Home</a> » <a href="about.html">Talk</a> </p>
            </div>

        </div>
        <div id="pages" class="pages" runat="server">
            <img class="hostcity_pic" src="/Content/Themes/Integration/MusicCompetition/v2/images/hostlocale.jpg" alt="Singapore Marina Bay, Gardens at the Bay" width="800" />
