<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="EventLogManager.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Central.Tools.EventLogManager" %>
...
<div class="control-box no-bottom-margin">
    <div>
        ...
        <asp:DropDownList ID="cboPeriod" runat="server" CssClass="input" AutoPostBack="True"></asp:DropDownList>
    </div>
</div>
    ...
    <asp:MultiView ID="MultiView1" ActiveViewIndex="0" runat="server">
        <asp:View ID="viewDetailed" runat="server">
            <asp:GridView ID="GridView1" runat="server" CssClass="table table-borderless" AllowPaging="True" AllowSorting="True"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="EventDate" SortExpression="EventDate" HeaderText="Date and Time"
                        HeaderStyle-HorizontalAlign="Left" />
                    <asp:BoundField DataField="User" HtmlEncode="false" SortExpression="User" HeaderText="User" HeaderStyle-HorizontalAlign="Left" />
            ...
            <asp:ObjectDataSource ID="ObjectDataSourceGrid" runat="server" SelectMethod="Select"
                TypeName="WCMS.WebSystem.WebParts.Central.Tools.EventLogManager">
                <SelectParameters>
