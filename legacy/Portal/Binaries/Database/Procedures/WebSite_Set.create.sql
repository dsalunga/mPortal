		...
		BEGIN
			...
			INSERT INTO WebSite
						(Name, Rank, Active, [Identity], Title, ParentId, HomePageId, DefaultMasterPageId, HostName, 
							...
							BaseAddress, SkinId, ThemeId, PrimaryIdentityId)
	...
	ELSE
		BEGIN
			...
			SET              Name = @Name, Rank = @Rank, Active = @Active, [Identity] = @Identity, Title = @Title, 
								...
								SkinId=@SkinId, ThemeId=@ThemeId, PrimaryIdentityId=@PrimaryIdentityId
			WHERE     (SiteId = @SiteId)
		END
