...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_ArticleTemplate_ItemTemplate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[ArticleTemplate] ADD  CONSTRAINT [DF_ArticleTemplate_ItemTemplate]  DEFAULT ('') FOR [ListItemTemplate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_ArticleTemplate_ListTemplate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[ArticleTemplate] ADD  CONSTRAINT [DF_ArticleTemplate_ListTemplate]  DEFAULT ('') FOR [ListTemplate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_ArticleTemplate_DetailsTemplate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[ArticleTemplate] ADD  CONSTRAINT [DF_ArticleTemplate_DetailsTemplate]  DEFAULT ('') FOR [DetailsTemplate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__ArticleTe__DateFormat]') AND type = 'D')
BEGIN
