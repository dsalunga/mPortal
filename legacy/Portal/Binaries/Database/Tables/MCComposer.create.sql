...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__Name]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__Name]  DEFAULT ('') FOR [Name]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__Entry]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__Entry]  DEFAULT ('') FOR [Entry]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__Locale]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__Locale]  DEFAULT ('') FOR [Locale]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__Work]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__Work]  DEFAULT ('') FOR [Work]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__Description]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__Description]  DEFAULT ('') FOR [Description]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__PhotoFile]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__PhotoFile]  DEFAULT ('') FOR [PhotoFile]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__NickName]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__NickName]  DEFAULT ('') FOR [NickName]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__Active]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCComposer] ADD  CONSTRAINT [DF__MCComposer__Active]  DEFAULT ((1)) FOR [Active]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__MCComposer__CompetitionId]') AND type = 'D')
BEGIN
