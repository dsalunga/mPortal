...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_Name]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_Name]  DEFAULT ('') FOR [Name]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_SourceTypeId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_SourceTypeId]  DEFAULT ((0)) FOR [SourceTypeId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_BaseAddress]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_BaseAddress]  DEFAULT ('') FOR [BaseAddress]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_UserName]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_UserName]  DEFAULT ('') FOR [UserName]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_Password]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_Password]  DEFAULT ('') FOR [Password]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_LastIndexDate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_LastIndexDate]  DEFAULT (getdate()) FOR [LastIndexDate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_Active]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_Active]  DEFAULT ((1)) FOR [Active]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_DisplayBaseAddress]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_DisplayBaseAddress]  DEFAULT ('') FOR [DisplayBaseAddress]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_DownloadCountSince]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_DownloadCountSince]  DEFAULT (getdate()) FOR [DownloadCountSince]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_FileCacheEnabled]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_FileCacheEnabled]  DEFAULT ((0)) FOR [FileCacheEnabled]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_FileCacheFolder]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_FileCacheFolder]  DEFAULT ('') FOR [FileCacheFolder]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_FileCacheMinDwldCount]') AND type = 'D')
BEGIN
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_FileCacheCeilSize]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_FileCacheCeilSize]  DEFAULT ((-1)) FOR [FileCacheCeilingSize]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_FileCacheMaxSize]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_FileCacheMaxSize]  DEFAULT ((-1)) FOR [FileCacheMaxSize]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_FileCacheMinDiskFree]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[RemoteLibrary] ADD  CONSTRAINT [DF_RemoteLibrary_FileCacheMinDiskFree]  DEFAULT ((-1)) FOR [FileCacheMinDiskFreeMB]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_RemoteLibrary_Size]') AND type = 'D')
BEGIN
