...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContents_VersionOfId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContents_VersionOfId]  DEFAULT ((-1)) FOR [VersionOf]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContents_VersionNo]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContents_VersionNo]  DEFAULT ((-1)) FOR [VersionNo]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContents_DirectoryId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContents_DirectoryId]  DEFAULT ((-1)) FOR [DirectoryId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContent_DateModified]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContent_DateModified]  DEFAULT (getdate()) FOR [DateModified]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContent_ContentTypeId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContent_ContentTypeId]  DEFAULT ((4)) FOR [ContentTypeId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContent_Active]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContent_Active]  DEFAULT ((1)) FOR [Active]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebContent_SiteId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF_WebContent_SiteId]  DEFAULT ((-1)) FOR [SiteId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebConten__EditorSensitive]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebContent] ADD  CONSTRAINT [DF__WebConten__EditorSensitive]  DEFAULT ((0)) FOR [EditorSensitive]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebConten_ActiveContent]') AND type = 'D')
BEGIN
