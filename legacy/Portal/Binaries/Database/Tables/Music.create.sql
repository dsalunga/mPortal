...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__Title]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__Title]  DEFAULT ('') FOR [Title]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__LanguageCode]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__LanguageCode]  DEFAULT ('') FOR [LanguageCode]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__CountryCode]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__CountryCode]  DEFAULT ('') FOR [CountryCode]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__FolderName]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__FolderName]  DEFAULT ('') FOR [FolderName]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__Tags]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__Tags]  DEFAULT ('') FOR [Tags]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__IsOriginal]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__IsOriginal]  DEFAULT ((1)) FOR [IsOriginal]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__ParentId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__ParentId]  DEFAULT ((-1)) FOR [ParentId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__CategoryId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__CategoryId]  DEFAULT ((-1)) FOR [CategoryId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__DateModified]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__DateModified]  DEFAULT (getdate()) FOR [DateModified]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__Composer]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Music] ADD  CONSTRAINT [DF__Music__Composer]  DEFAULT ('') FOR [Composer]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__Music__DateComposed]') AND type = 'D')
BEGIN
