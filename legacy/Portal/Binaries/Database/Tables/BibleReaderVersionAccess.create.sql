...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_BibleReaderVersionAccess_BibleVersionId]') AND type = 'D')
BEGIN
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_BibleReaderVersionAccess_BibleVersionName]') AND type = 'D')
BEGIN
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_BibleReaderVersionAccess_LastAccess]') AND type = 'D')
BEGIN
...
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_BibleReaderVersionAccess_VersionAccessCount]') AND type = 'D')
BEGIN
