...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_Name]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebOffice] ADD  CONSTRAINT [DF_WebOffice_Name]  DEFAULT ('') FOR [Name]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_ParentId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebOffice] ADD  CONSTRAINT [DF_WebOffice_ParentId]  DEFAULT ((-1)) FOR [ParentId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_AddressLine1]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebOffice] ADD  CONSTRAINT [DF_WebOffice_AddressLine1]  DEFAULT ('') FOR [AddressLine1]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_MobileNumber]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebOffice] ADD  CONSTRAINT [DF_WebOffice_MobileNumber]  DEFAULT ('') FOR [MobileNumber]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_PhoneNumber]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebOffice] ADD  CONSTRAINT [DF_WebOffice_PhoneNumber]  DEFAULT ('') FOR [PhoneNumber]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_EmailAddress]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebOffice] ADD  CONSTRAINT [DF_WebOffice_EmailAddress]  DEFAULT ('') FOR [EmailAddress]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebOffice_ContactPersonId]') AND type = 'D')
BEGIN
