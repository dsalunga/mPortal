...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Table1_HomeAddressLine1]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_Table1_HomeAddressLine1]  DEFAULT ('') FOR [AddressLine1]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_AddressLine2]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_WebAddress_AddressLine2]  DEFAULT ('') FOR [AddressLine2]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_CityTown]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_WebAddress_CityTown]  DEFAULT ('') FOR [CityTown]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_StateProvince]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_WebAddress_StateProvince]  DEFAULT ('') FOR [StateProvince]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Table1_HomeAddressStateCode]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_Table1_HomeAddressStateCode]  DEFAULT ((-1)) FOR [StateProvinceCode]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Table1_HomeAddressCountryCode]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_Table1_HomeAddressCountryCode]  DEFAULT ((-1)) FOR [CountryCode]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Table1_HomeAddressZipCode]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_Table1_HomeAddressZipCode]  DEFAULT ('') FOR [ZipCode]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_PhoneNumber]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_WebAddress_PhoneNumber]  DEFAULT ('') FOR [PhoneNumber]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_UserId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_WebAddress_UserId]  DEFAULT ((-1)) FOR [ObjectId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_RecordId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebAddress] ADD  CONSTRAINT [DF_WebAddress_RecordId]  DEFAULT ((-1)) FOR [RecordId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebAddress_LastUpdated]') AND type = 'D')
BEGIN
