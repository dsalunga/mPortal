...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPageElement_ObjectId_1]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPageElement] ADD  CONSTRAINT [DF_WebPageElement_ObjectId_1]  DEFAULT ((2)) FOR [ObjectId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPageElement_UsePartTemplatePath_1]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPageElement] ADD  CONSTRAINT [DF_WebPageElement_UsePartTemplatePath_1]  DEFAULT ((1)) FOR [UsePartTemplatePath]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPageElement_PublicAccess]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPageElement] ADD  CONSTRAINT [DF_WebPageElement_PublicAccess]  DEFAULT ((1)) FOR [PublicAccess]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPageElement_DateModified]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPageElement] ADD  CONSTRAINT [DF_WebPageElement_DateModified]  DEFAULT (getdate()) FOR [DateModified]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPageElement_ManagementAccess]') AND type = 'D')
BEGIN
