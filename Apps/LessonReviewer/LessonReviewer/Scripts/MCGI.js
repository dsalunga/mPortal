    ...
    Dom: {
        ...
        */
        ...
        Open: function (url, w, h) {
            ...
            window.open(url, null, 'toolbar=yes,menubar=yes,scrollbars=yes,resizable=yes,width=' + width + ',height=' + height + ',left=' + wLeft + ',top=' + wTop);
        },
    ...
    Effects: {
        Overlay: {
            Show: function () {
                ...
                // Apply overlay
                var divOverlay = document.getElementById("des_Overlay");
                if (divOverlay == null) {
                    divOverlay = document.createElement("DIV");
                    divOverlay.id = "des_Overlay";
                    document.body.appendChild(divOverlay);
                }

                divOverlay.className = "ShadeOverlay";
                //divOverlay.style.height = MCGI.Dom.GetDocumentHeight();
