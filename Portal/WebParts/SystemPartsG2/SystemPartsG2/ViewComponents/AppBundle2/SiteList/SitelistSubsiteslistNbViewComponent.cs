...
namespace WCMS.WebSystem.WebParts.G2.ViewComponents
{
    ...
    public class SitelistSubsiteslistNbViewComponent : WViewComponent
    {
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            return View("~/Views/Shared/Components/AppBundle2/SiteList/subsiteslist_nb/SitelistSubsiteslistNb/Default.cshtml", model);
        }
    }
        ...
        public class SitelistSubsiteslistNbViewModel
    {
        ...
        public List<SitelistSubsiteslistNbItem> Items { get; set; } = new();
    }

    public class SitelistSubsiteslistNbItem
    {
