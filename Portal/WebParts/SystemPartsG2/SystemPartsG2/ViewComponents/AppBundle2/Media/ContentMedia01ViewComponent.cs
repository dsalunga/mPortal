...
namespace WCMS.WebSystem.WebParts.G2.ViewComponents
{
    ...
    public class ContentMedia01ViewComponent : WViewComponent
    {
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            return View("~/Views/Shared/Components/AppBundle2/Media/content_media_01/ContentMedia01/Default.cshtml", model);
        }
    }
        ...
        public class ContentMedia01ViewModel
    {
        ...
        public List<ContentMedia01Item> Items { get; set; } = new();
        public int PageSize { get; set; } = 20;
        public int TotalItems { get; set; }
    }

    public class ContentMedia01Item
    {
