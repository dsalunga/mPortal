...
{
    /// <summary>
    /// Legacy-compatible replacement for AppBundle2/FlashBanner/Handler.ashx.
    /// </summary>
    [ApiController]
    [AllowAnonymous]
    public class LegacyFlashBannerHandlerController : ControllerBase
    {
        ...
        [HttpGet("/Content/Parts/AppBundle2/FlashBanner/Handler.ashx")]
        [HttpGet("/_Sections/FlashBanner/Handler.ashx")]
        public IActionResult GetFlashBannerXml()
        {
