namespace WCMS.WebSystem.WebParts.Media
{
	...
	/// </summary>
	public partial class CONTENT_Media_01 : System.Web.UI.UserControl
	{
		...
		{
			DataSet ds = SqlHelper.ExecuteDataSet("MG_C_SELECT_MediaGallery");
		...
		protected void cmdDelete_Click(object sender, System.EventArgs e)
		{
			...
			{
				SqlHelper.ExecuteNonQuery(CommandType.Text,"DELETE FROM  MediaGallery WHERE MediaID IN (" + sChecked + ");");
				this.LoadData(0);
			}
		}
