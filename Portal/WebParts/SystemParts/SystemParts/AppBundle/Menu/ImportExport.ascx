<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="ImportExport.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Menu.ImportExport" %>
...
<asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
    <asp:View ID="viewExport" runat="server">
        <div>
            <asp:DropDownList ID="cboMenus" runat="server" DataSourceID="ObjectDataSource1" DataTextField="Name"
                DataValueField="Id">
            </asp:DropDownList>
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetList"
                TypeName="WCMS.WebSystem.WebParts.Menu.ImportExport"></asp:ObjectDataSource>
        </div>
        <div>
            &nbsp;
        </div>
