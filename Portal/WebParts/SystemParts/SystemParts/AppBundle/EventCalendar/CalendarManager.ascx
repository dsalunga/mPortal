<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CalendarManager.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.EventCalendar.CalendarManager" %>
<div class="control-box no-bottom-margin">
    <div>
        <asp:Button ID="cmdNew" runat="server" Text="New Calendar" CssClass="btn btn-default btn-sm" OnClick="cmdNew_Click" />
...
<div>
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-borderless"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="SiteName" HeaderText="Owner Site" SortExpression="SiteName" HeaderStyle-HorizontalAlign="Left">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.WebParts.EventCalendar.CalendarManager">
        <SelectParameters>
