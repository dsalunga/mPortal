<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AdminCategoryManager.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.EventCalendar.AdminCategoryManager" %>
...
<div class="table-responsive">
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-borderless"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="TemplateName" HeaderText="Template" SortExpression="TemplateName"
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.WebParts.EventCalendar.AdminCategoryManager">
        <SelectParameters>
