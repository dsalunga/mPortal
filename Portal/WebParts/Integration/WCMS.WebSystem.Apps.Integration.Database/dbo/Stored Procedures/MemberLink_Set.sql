	...
	IF(@MemberLinkId > 0)
		BEGIN
			...
			SET                UserId = @UserId, MemberId = @MemberId, ExternalIdNo = @ExternalIdNo, HomeAddressLine1 = @HomeAddressLine1, HomeAddressLine2 = @HomeAddressLine2,
			                         ...
			                         Approved=@Approved, Locale=@Locale, Private=@Private, AdditionalInfo=@AdditionalInfo
	...
	ELSE
		BEGIN
			...
			INSERT INTO MemberLink
			                         ...
			                         LastUpdate, PhotoPath, MembershipDate, Approved, Locale, Private, AdditionalInfo)
