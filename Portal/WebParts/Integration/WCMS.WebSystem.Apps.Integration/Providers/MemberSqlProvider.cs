...
{
    public class MemberSqlProvider : IMemberProvider
    {
        #region IDataProvider<Member> Members

        public bool Delete(int id)
        {
            SqlHelper.ExecuteNonQuery("Member_Del",
        ...
        {
            using (var r = SqlHelper.ExecuteReader("Member_Get",
                new SqlParameter("@MemberId", id)))
            {
                if (r.Read())
                {
        ...
        public int Update(Member item)
        {
            ...
            var o = SqlHelper.ExecuteReader("Member_Set",
