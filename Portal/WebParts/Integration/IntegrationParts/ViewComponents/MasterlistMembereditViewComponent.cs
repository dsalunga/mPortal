...
namespace WCMS.WebSystem.WebParts.Integration.ViewComponents
{
    ...
    /// </summary>
    public class MasterlistMembereditViewComponent : WViewComponent
    {
        public MasterlistMembereditViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new MasterlistMembereditViewModel
            {
        ...
        public class MasterlistMembereditViewModel
    {
