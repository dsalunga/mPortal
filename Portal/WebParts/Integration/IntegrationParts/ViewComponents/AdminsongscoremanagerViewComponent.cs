...
namespace WCMS.WebSystem.WebParts.Integration.ViewComponents
{
    ...
    /// </summary>
    public class AdminsongscoremanagerViewComponent : WViewComponent
    {
        public AdminsongscoremanagerViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new AdminsongscoremanagerViewModel
            {
