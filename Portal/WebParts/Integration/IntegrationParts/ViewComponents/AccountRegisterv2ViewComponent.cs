...
{
    /// <summary>
    /// Ported from RegisterV2.ascx (Apps/Integration/Account).
    /// </summary>
    public class AccountRegisterv2ViewComponent : WViewComponent
    {
        public AccountRegisterv2ViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new AccountRegisterv2ViewModel
            {
        ...
        public class AccountRegisterv2ViewModel
    {
