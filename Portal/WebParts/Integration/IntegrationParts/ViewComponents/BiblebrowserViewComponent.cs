...
namespace WCMS.WebSystem.WebParts.Integration.ViewComponents
{
    ...
    /// </summary>
    public class BiblebrowserViewComponent : WViewComponent
    {
        public BiblebrowserViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new BiblebrowserViewModel
            {
        ...
        public class BiblebrowserViewModel
    {
