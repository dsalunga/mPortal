...
namespace WCMS.WebSystem.WebParts.Integration.ViewComponents
{
    ...
    /// </summary>
    public class RegistrationRegistrationv2ViewComponent : WViewComponent
    {
        public RegistrationRegistrationv2ViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new RegistrationRegistrationv2ViewModel
            {
        ...
        public class RegistrationRegistrationv2ViewModel
    {
