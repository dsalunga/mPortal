...
namespace WCMS.WebSystem.WebParts.Integration.ViewComponents
{
    ...
    /// </summary>
    public class MembervisitentryViewComponent : WViewComponent
    {
        public MembervisitentryViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new MembervisitentryViewModel
            {
        ...
        public class MembervisitentryViewModel
    {
