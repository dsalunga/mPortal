...
namespace WCMS.WebSystem.WebParts.Integration.ViewComponents
{
    ...
    /// </summary>
    public class MusiccompetitionCandidateeditViewComponent : WViewComponent
    {
        public MusiccompetitionCandidateeditViewComponent(IWContext context) : base(context) { }
        ...
        public IViewComponentResult Invoke(int objectId = 0, int recordId = 0)
        {
            ...
            var model = new MusiccompetitionCandidateeditViewModel
            {
        ...
        public class MusiccompetitionCandidateeditViewModel
    {
