...
<h4 class="heading colr" runat="server" id="lblHeader">Member Profile</h4>
...
<asp:MultiView ID="MultiView1" runat="server" ActiveViewIndex="0">
    <asp:View ID="viewProfile" runat="server">
        <a runat="server" id="linkUpdatePhoto" title="Update Profile Photo">
            <img src="/Content/Assets/Images/nophoto.png" width="300" runat="server" id="memberPhoto" style="border: solid 2px #aaa; margin: 2px 0 2px 0" />
        </a>
        <br />
        ...
        <div class="FieldLine" runat="server" id="panelEmail" visible="false">
            <span class="FieldLabel">Email Address</span> <strong runat="server" id="lblEmail"></strong>
        </div>
        ...
        <div class="FieldLine">
            <span class="FieldLabel">Church ID #</span> <strong runat="server" id="lblExternalIdNo"></strong>
        </div>
        <div class="FieldLine">
        ...
        <div style="float: left; clear: both">
            ...
            <div runat="server" id="panelGS" visible="false">
                <br />
                <br />
                <h4 class="heading colr">GS and AGS Assigned</h4>
                <div style="margin-left: 20px">
            ...
            <div id="panelPrivacy" runat="server" visible="false" clientidmode="static">
                <br />
                <br />
    ...
    <asp:View ID="viewOtherInfo" runat="server">
        <br />
        <h4 class="heading colr">Additional Information:</h4>
        <asp:MultiView ID="MultiViewOtherInfo" runat="server" ActiveViewIndex="0">
            ...
            <asp:View ID="viewOtherInfoEdit" runat="server">
                <asp:TextBox ID="txtAdditionalInfo" MaxLength="4000" CssClass="input-xlarge" runat="server" Columns="60"
