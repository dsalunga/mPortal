<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GroupUserManager.ascx.cs" Inherits="WCMS.WebSystem.Apps.Integration.MusicMinistry.MasterList.GroupUserManager" %>
