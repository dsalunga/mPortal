<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="GroupManager.ascx.cs" Inherits="WCMS.WebSystem.Apps.Integration.MusicMinistry.MasterList.GroupManager" %>
<%@ Import Namespace="WCMS.Common.Utilities" %>
<%@ Import Namespace="WCMS.Framework" %>
<%@ Register Src="Controls/WebGroupTab.ascx" TagName="WebGroupTab" TagPrefix="uc1" %>

<script runat="server">
    public string FormatName(string name, int id)
    {
...
<uc1:WebGroupTab ID="WebGroupTab1" runat="server" SelectedTab="Groups" />
...
<div class="min-bottom-margin">
    <% if (IsManager)
       { %>
    <a href="#" runat="server" id="linkNewGroup" class="btn btn-default">New Group</a>
    ...
    <div class="pull-right">
        <span class="input-append">
            <asp:TextBox ID="txtSearch" runat="server" CssClass="col-md-2" ClientIDMode="Static" placeholder="Search"></asp:TextBox>
            <button class="btn btn-default" type="button">Search</button>
        </span>
        <%--<asp:LinkButton ID="cmdDownload" runat="server" Text="Download" OnClick="cmdDownload_Click" />--%>
...
<asp:GridView CssClass="table" ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False"
    ...
    <Columns>
        ...
        <asp:TemplateField HeaderText="Name" SortExpression="Name" HeaderStyle-HorizontalAlign="Left">
            <ItemTemplate>
                <img src='/Content/Assets/Images/Common/folder2.gif' />
        ...
        <asp:HyperLinkField DataNavigateUrlFields="OwnerId" DataNavigateUrlFormatString="/Central/Security/WebUserHome/?UserId={0}"
            DataTextField="Owner" HeaderText="Assigned Councillor" SortExpression="Owner" Target="_blank"
