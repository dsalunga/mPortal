<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CompositeGroupManager.ascx.cs" Inherits="WCMS.WebSystem.Apps.Integration.MusicMinistry.MasterList.CompositeGroupManager" %>
