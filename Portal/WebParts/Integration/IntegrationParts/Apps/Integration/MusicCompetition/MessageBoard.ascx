<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MessageBoard.ascx.cs" Inherits="WCMS.WebSystem.Apps.MusicCompetition.MessageBoard" %>
...
<asp:ObjectDataSource ID="ObjectDataSourceComments" runat="server" SelectMethod="Select"
    TypeName="WCMS.WebSystem.Apps.MusicCompetition.MessageBoard">
    <SelectParameters>
...
<div>
    ...
    <br />
    <asp:TextBox runat="server" ID="txtName" Style="width: 60%"></asp:TextBox><br />
    ...
    <br />
    <asp:TextBox runat="server" ID="txtEmail" Style="width: 60%"></asp:TextBox><br />
    <span>Comment<span class="required">*<asp:RequiredFieldValidator ID="rfvMessage" runat="server" ErrorMessage="Message" ForeColor="Red" ControlToValidate="txtComment">*</asp:RequiredFieldValidator></span></span><br />
    <asp:TextBox runat="server" ID="txtComment" Style="width: 60%; height: 150px;" TextMode="MultiLine"></asp:TextBox><br />
    <button runat="server" id="cmdPost" style="margin-top: 15px;" onserverclick="cmdPost_ServerClick">Submit Comment</button>
</div>
