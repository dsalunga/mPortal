...
{
    public partial class AdminCompetitionManagerView : System.Web.UI.UserControl
    {
        ...
        protected void GridView1_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            switch (e.CommandName)
            {
                case "Custom_Edit":
                    ...
                    query.LoadAndRedirect("AdminCompetitionEdit.ascx");
                    break;
        ...
        public DataSet Select(string keyword)
        {
            ...
            return DataHelper.ToDataSet(
                ...
                select new
                {
                    item.Id,
                    item.Name,
                    NameUrl = query.Set(WebColumns.Id, item.Id).BuildQuery(),
                    item.Judges,
                    ScoreLocked = item.IsScoreLocked ? "Locked" : "Open",
                    VotingLocked = item.IsVoteLocked ? "Closed" : "Open",
