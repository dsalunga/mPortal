            ...
            $.ajax({
                ...
                success: function (data) {
                    ...
                    if (data.d) {
                        ...
                        $("#photo").attr("src", data.d.PhotoFile == "" ? "/Content/Parts/MusicCompetition/v3-res/img-vote/image.png" : "/Content/Parts/MusicCompetition/v3-res/entries/400px/" + data.d.PhotoFile);
    ...
    */
    ...
    $('#votenow').click(function () {
        ...
        */
        ...
        if (errorMessage != "") {
            showAlert("The following fields are required:<ul>" + errorMessage + "</ul>", "Missing fields", "#pageVoting");
            return false;
        }
        ...
        if (lEmail.indexOf("+") != -1 || lEmail.indexOf("@") == -1 || lEmail.indexOf("@yopmail.com") != -1) {
            showAlert("Invalid email format.", "Invalid email", "#pageVoting");
            return false;
        }
            ...
            success: function (data) {
                ...
                if (data.d == 0) {
                    ...
                    */
                    ...
                    if (isSvcAccount) {
                        $('#afterVoteInfoConfirm').slideToggle('fast');
                    }
                    else {
                        $('#afterVoteInfo').slideToggle('fast');
                    }
    ...
    $('.comentry').hover(
        ...
        function () {
            ...
            $(this).find('.roundcorner2').css('margin-top', '0px;');
            $(this).css('opacity', 1);
        }
    );
