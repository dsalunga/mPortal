<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="InstanceManagerView.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Incident.InstanceManagerView" %>
<div class="control-box no-bottom-margin">
    <div>
        <asp:Button ID="cmdNew" runat="server" Text="New Instance" CssClass="btn btn-default btn-sm" OnClick="cmdNew_Click" />
...
<div class="table-responsive">
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.WebParts.Incident.InstanceManagerView">
        <SelectParameters>
