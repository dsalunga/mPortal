...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebShare__Object]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebShare] ADD  CONSTRAINT [DF__WebShare__Object]  DEFAULT ((-1)) FOR [ObjectId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebShare__Record]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebShare] ADD  CONSTRAINT [DF__WebShare__Record]  DEFAULT ((-1)) FOR [RecordId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebShare__ShareO]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebShare] ADD  CONSTRAINT [DF__WebShare__ShareO]  DEFAULT ((-1)) FOR [ShareObjectId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebShare__ShareR]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebShare] ADD  CONSTRAINT [DF__WebShare__ShareR]  DEFAULT ((-1)) FOR [ShareRecordId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebShare__Allow]') AND type = 'D')
BEGIN
