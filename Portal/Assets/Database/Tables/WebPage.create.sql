...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_PartControlTemplateId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_PartControlTemplateId]  DEFAULT ((-1)) FOR [PartControlTemplateId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_Published]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_Published]  DEFAULT ((-1)) FOR [Published]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_VersionOfId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_VersionOfId]  DEFAULT ((-1)) FOR [VersionOfId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_AuthMethodId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_AuthMethodId]  DEFAULT ((128)) FOR [PublicAccess]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_DateCreated]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_DateCreated]  DEFAULT (getdate()) FOR [DateCreated]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_DateModified]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_DateModified]  DEFAULT (getdate()) FOR [DateModified]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_PageType]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_PageType]  DEFAULT ((0)) FOR [PageType]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPages_UseTemplatePath]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPages_UseTemplatePath]  DEFAULT ((1)) FOR [UsePartTemplatePath]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPage_ManagementAccess]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPage_ManagementAccess]  DEFAULT ((0)) FOR [ManagementAccess]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebPage_ThemeId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF_WebPage_ThemeId]  DEFAULT ((-1)) FOR [ThemeId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebPage__LocaleId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebPage] ADD  CONSTRAINT [DF__WebPage__LocaleId]  DEFAULT ((-1)) FOR [LocaleId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebPage__SkinId]') AND type = 'D')
BEGIN
