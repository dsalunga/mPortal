...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTemplates_PrimaryPanelId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF_WebTemplates_PrimaryPanelId]  DEFAULT ((-1)) FOR [PrimaryPanelId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTemplate_Version]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF_WebTemplate_Version]  DEFAULT ((1)) FOR [Version]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTemplate_LatestVersion]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF_WebTemplate_LatestVersion]  DEFAULT ((1)) FOR [VersionOf]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTemplate_Content]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF_WebTemplate_Content]  DEFAULT ('') FOR [Content]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTemplate_SkinId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF_WebTemplate_SkinId]  DEFAULT ((-1)) FOR [ThemeId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebTempla__Standalone]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF__WebTempla__Standalone]  DEFAULT ((0)) FOR [Standalone]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebTempla__ParentId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF__WebTempla__ParentId]  DEFAULT ((-1)) FOR [ParentId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebTempla__SkinId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTemplate] ADD  CONSTRAINT [DF__WebTempla__SkinId]  DEFAULT ((-1)) FOR [SkinId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebTempla__TemplateEngineId]') AND type = 'D')
BEGIN
