...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_EntryDate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_EntryDate]  DEFAULT (getdate()) FOR [EntryDate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Country]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Country]  DEFAULT ('') FOR [Country]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Locale]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Locale]  DEFAULT ('') FOR [Locale]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_ExternalId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_ExternalId]  DEFAULT ('') FOR [ExternalId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Name]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Name]  DEFAULT ('') FOR [Name]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Designation]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Designation]  DEFAULT ('') FOR [Designation]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Airline]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Airline]  DEFAULT ('') FOR [Airline]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_FlightNo]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_FlightNo]  DEFAULT ('') FOR [FlightNo]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Suggestion]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Suggestion]  DEFAULT ('') FOR [Address]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Age]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Age]  DEFAULT ((-1)) FOR [Age]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_Gender]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[Registration] ADD  CONSTRAINT [DF_Registration_Gender]  DEFAULT ('') FOR [Gender]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_Registration_PlaceType]') AND type = 'D')
BEGIN
