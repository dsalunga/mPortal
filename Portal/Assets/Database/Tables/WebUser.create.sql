...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_MiddleName]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_MiddleName]  DEFAULT ('') FOR [MiddleName]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_LastUpdate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_LastUpdate]  DEFAULT (getdate()) FOR [LastUpdate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_Active]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_Active]  DEFAULT ((0)) FOR [Active]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_RegCode]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_RegCode]  DEFAULT ('') FOR [ActivationKey]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_DateCreated]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_DateCreated]  DEFAULT (getdate()) FOR [DateCreated]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_NewEmail]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_NewEmail]  DEFAULT ('') FOR [NewEmail]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_Email2]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_Email2]  DEFAULT ('') FOR [Email2]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_Gender]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_Gender]  DEFAULT ('U') FOR [Gender]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_NameSuffix]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_NameSuffix]  DEFAULT ('') FOR [NameSuffix]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_MobileNumber]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_MobileNumber]  DEFAULT ('') FOR [MobileNumber]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_TelephoneNumber]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_TelephoneNumber]  DEFAULT ('') FOR [TelephoneNumber]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_LastLoginDate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_LastLoginDate]  DEFAULT (getdate()) FOR [LastLogin]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_StatusText]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_StatusText]  DEFAULT ('') FOR [StatusText]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_PasswordExpiryDate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_PasswordExpiryDate]  DEFAULT ('1800-01-01') FOR [PasswordExpiryDate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_PhotoPath]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_PhotoPath]  DEFAULT ('') FOR [PhotoPath]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_ProviderId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_ProviderId]  DEFAULT ((-1)) FOR [ProviderId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_Status]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_Status]  DEFAULT ((-1)) FOR [Status]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_MaritalStatus]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_MaritalStatus]  DEFAULT ((-1)) FOR [MaritalStatusId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebUser_LastLoginFailureDate]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebUser] ADD  CONSTRAINT [DF_WebUser_LastLoginFailureDate]  DEFAULT ('1800-01-01') FOR [LastLoginFailureDate]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__WebUser__LoginFailureCount]') AND type = 'D')
BEGIN
