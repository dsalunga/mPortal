...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_FromObjectId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMessageQueue] ADD  CONSTRAINT [DF_WebMessageQueue_FromObjectId]  DEFAULT ((-1)) FOR [FromObjectId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_FromRecordId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMessageQueue] ADD  CONSTRAINT [DF_WebMessageQueue_FromRecordId]  DEFAULT ((-1)) FOR [FromRecordId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_ToOrBcc]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMessageQueue] ADD  CONSTRAINT [DF_WebMessageQueue_ToOrBcc]  DEFAULT ((0)) FOR [ToOrBcc]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_DateCreated]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMessageQueue] ADD  CONSTRAINT [DF_WebMessageQueue_DateCreated]  DEFAULT (getdate()) FOR [DateCreated]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_DateSent]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMessageQueue] ADD  CONSTRAINT [DF_WebMessageQueue_DateSent]  DEFAULT (getdate()) FOR [DateSent]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_Status]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMessageQueue] ADD  CONSTRAINT [DF_WebMessageQueue_Status]  DEFAULT ((0)) FOR [Status]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMessageQueue_EnableMonitor]') AND type = 'D')
BEGIN
