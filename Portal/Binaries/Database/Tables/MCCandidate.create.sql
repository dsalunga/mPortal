...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_Name]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_Name]  DEFAULT ('') FOR [Name]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_Entry]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_Entry]  DEFAULT ('') FOR [Entry]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_Lyrics]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_Lyrics]  DEFAULT ('') FOR [Lyrics]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_SourceUrl]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_SourceUrl]  DEFAULT ('') FOR [SourceUrl]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_SourceUrl2]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_SourceUrl2]  DEFAULT ('') FOR [SourceUrl2]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_Lyricist]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_Lyricist]  DEFAULT ('') FOR [Lyricist]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_Interpreter]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_Interpreter]  DEFAULT ('') FOR [Interpreter]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_PhotoFile]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_PhotoFile]  DEFAULT ('') FOR [PhotoFile]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_CompetitionId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_CompetitionId]  DEFAULT ((-1)) FOR [CompetitionId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_Rank]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[MCCandidate] ADD  CONSTRAINT [DF_MCCandidate_Rank]  DEFAULT ((0)) FOR [Rank]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_MCCandidate_WinnerRank]') AND type = 'D')
BEGIN
