...
GO
IF  EXISTS (SELECT * FROM dbo.sysobjects WHERE id = OBJECT_ID(N'[DF__IncidentT__Insta__5083074D]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentType] DROP CONSTRAINT [DF__IncidentT__Insta__5083074D]
END
