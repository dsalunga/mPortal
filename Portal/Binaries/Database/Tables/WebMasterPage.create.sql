...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPages_OwnerPageId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPages_OwnerPageId]  DEFAULT ((-1)) FOR [OwnerPageId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPages_AuthenticationTypeId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPages_AuthenticationTypeId]  DEFAULT ((1)) FOR [PublicAccess]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPages_DateCreated]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPages_DateCreated]  DEFAULT (getdate()) FOR [DateCreated]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPages_DateModified]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPages_DateModified]  DEFAULT (getdate()) FOR [DateModified]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPage_ManagementAccess]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPage_ManagementAccess]  DEFAULT ((0)) FOR [ManagementAccess]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPage_ThemeId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPage_ThemeId]  DEFAULT ((-1)) FOR [ThemeId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPage__SkinId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebMasterPage] ADD  CONSTRAINT [DF_WebMasterPage__SkinId]  DEFAULT ((-1)) FOR [SkinId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebMasterPage_ParentId]') AND type = 'D')
BEGIN
