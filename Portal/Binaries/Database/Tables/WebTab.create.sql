...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTab_Text]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTab] ADD  CONSTRAINT [DF_WebTab_Text]  DEFAULT ('') FOR [Text]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTab_Target]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTab] ADD  CONSTRAINT [DF_WebTab_Target]  DEFAULT ('') FOR [Target]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTab_Rank]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTab] ADD  CONSTRAINT [DF_WebTab_Rank]  DEFAULT ((0)) FOR [Rank]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTab_TabSetId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[WebTab] ADD  CONSTRAINT [DF_WebTab_TabSetId]  DEFAULT ((-1)) FOR [TabSetId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_WebTab_Name]') AND type = 'D')
BEGIN
