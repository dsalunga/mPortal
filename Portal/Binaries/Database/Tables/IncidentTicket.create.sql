...
END
GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_GroupId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_GroupId]  DEFAULT ((-1)) FOR [AssignedGroupId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_AssignedUserId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_AssignedUserId]  DEFAULT ((-1)) FOR [AssignedUserId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_TicketGuid]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_TicketGuid]  DEFAULT ('') FOR [TicketGuid]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_SubmitterId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_SubmitterId]  DEFAULT ((-1)) FOR [SubmitterId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_ETA]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_ETA]  DEFAULT ('1800-01-01') FOR [ETA]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_TypeId]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_TypeId]  DEFAULT ((-1)) FOR [TypeId]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF_IncidentTicket_NotifyAlso]') AND type = 'D')
BEGIN
ALTER TABLE [dbo].[IncidentTicket] ADD  CONSTRAINT [DF_IncidentTicket_NotifyAlso]  DEFAULT ('') FOR [NotifyAlso]
END

GO
IF NOT EXISTS (SELECT * FROM sys.objects WHERE object_id = OBJECT_ID(N'[dbo].[DF__IncidentT__Insta__282DF8C2]') AND type = 'D')
BEGIN
