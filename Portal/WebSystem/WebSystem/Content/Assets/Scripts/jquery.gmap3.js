    ...
    $.fn.gmap3 = function (options) {
        ...
        this.initialize = function () {
            ...
            var settings = {
                ...
                center: latlng,
                mapTypeControl: true,
                mapTypeControlOptions: { style: google.maps.MapTypeControlStyle.HORIZONTAL_BAR /*DROPDOWN_MENU*/ },
                navigationControl: options.navControl,
                navigationControlOptions: { style: google.maps.NavigationControlStyle.DEFAULT /* SMALL */ },
        ...
        function _addMarkerByLatLng(latlng, title, html, theMap, overlays) {
            ...
            //alert("title: " + title + ", overlays: " + overlays);
            if (overlays != null) {
