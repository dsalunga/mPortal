        ...
        <asp:View ID="viewLogin" runat="server">
            ...
            <table border="0">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtUserName" CssClass="input" Columns="30" ClientIDMode="Static" runat="server" Text=""></asp:TextBox>
                    </td>
                </tr>
                <tr>
                    ...
                    <td style="padding-top: 10px">
                        <asp:TextBox ID="txtPassword" CssClass="input" Columns="30" ClientIDMode="Static" runat="server" TextMode="Password" Text=""></asp:TextBox>
                    </td>
                </tr>
