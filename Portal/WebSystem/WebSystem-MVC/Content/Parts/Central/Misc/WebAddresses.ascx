<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebAddresses.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Central.Misc.WebAddresses" %>
...
<div class="control-box no-bottom-margin">
    <div>
        <asp:Button ID="cmdNew" runat="server" Text="New Address" CssClass="btn btn-default btn-sm" OnClick="cmdNew_Click" />
        <div class="pull-right">
            <asp:TextBox ID="txtSearch" Columns="25" CssClass="input" runat="server"></asp:TextBox>
...
<div>
    <asp:GridView ID="GridView1" runat="server" AllowSorting="True" AutoGenerateColumns="False" CssClass="table table-borderless"
        ...
        <Columns>
            ...
            <asp:BoundField DataField="Tag" HeaderText="Tag" SortExpression="Tag" HeaderStyle-HorizontalAlign="Left" />
        </Columns>
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="Select"
        TypeName="WCMS.WebSystem.WebParts.Central.Misc.WebAddresses">
        <SelectParameters>
