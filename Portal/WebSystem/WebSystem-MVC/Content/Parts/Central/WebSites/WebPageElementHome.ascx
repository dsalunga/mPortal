<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebPageElementHome.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Central.WebSites.WebPageElementHome" %>
    ...
    <div class="col-md-6">
        ...
        <table>
            ...
            <tr>
                ...
                <td>
                    <a runat="server" id="lblPanel" href="#"></a>
                </td>
            </tr>
            <tr>
                <td>Owner
