...
{
    public partial class WebTemplatePanelController : System.Web.UI.UserControl
    {
        protected void Page_Load(object sender, System.EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                int templatePanelId = query.GetId(WebColumns.TemplatePanelId);
        ...
        protected void cmdUpdate_Click(object sender, System.EventArgs e)
        {
            ...
            WebTemplatePanel item = (panelId > 0) ? WebTemplatePanel.Get(panelId) : new WebTemplatePanel();
