<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebTemplatePanel.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Central.Template.WebTemplatePanelController" %>
