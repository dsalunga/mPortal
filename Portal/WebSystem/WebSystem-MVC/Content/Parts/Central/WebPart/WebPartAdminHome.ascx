<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebPartAdminHome.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Central.WebPartAdminHome" %>
<h1 class="central page-header" runat="server" id="lblTitle">
</h1>
                ...
                <tr>
                    <td rowspan="2">
                        <a href="#" id="linkConfigPage" runat="server">
                            <img src="/Content/Assets/Images/file_edit.png" class="TaskListIcon" border="0" /></a>
                    </td>
                    <td class="Header">
                        Properties
                    </td>
