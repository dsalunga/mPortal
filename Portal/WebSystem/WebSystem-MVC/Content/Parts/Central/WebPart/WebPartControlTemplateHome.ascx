<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WebPartControlTemplateHome.ascx.cs"
    Inherits="WCMS.WebSystem.WebParts.Central.WebPartControlTemplateHome" %>
...
<%--<h1 runat="server" id="lblTemplate"></h1>--%>
<br />
<table width="100%">
    <tr>
        <td>
